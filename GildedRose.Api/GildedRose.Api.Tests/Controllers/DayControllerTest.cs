...
namespace GildedRose.Api.Tests.Controllers
{
    ...
    {
        [TestMethod]
        public void DayControllerEndDayInvokesIncrementDay()
        {
            // Arrange
            ...
            var itemsController = new DayController(itemsControllerMock.Object);

            // Act
            var findItems = itemsController.EndDay(1).ToList();
