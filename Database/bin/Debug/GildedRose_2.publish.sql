...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [inventory_13DEC52C], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_inventory_13DEC52C.mdf') TO FILEGROUP [inventory];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [membership_7E9FAEB4], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_membership_7E9FAEB4.mdf') TO FILEGROUP [membership];
