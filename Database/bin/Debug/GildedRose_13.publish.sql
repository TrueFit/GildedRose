...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [inventory_51F26ED3], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_inventory_51F26ED3.mdf') TO FILEGROUP [inventory];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [membership_79A15250], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_membership_79A15250.mdf') TO FILEGROUP [membership];
