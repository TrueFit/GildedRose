...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [inventory_247B338], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_inventory_247B338.mdf') TO FILEGROUP [inventory];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [membership_7F3A984], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_membership_7F3A984.mdf') TO FILEGROUP [membership];
